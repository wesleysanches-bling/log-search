import {
  script as script12,
  script2 as script13
} from "./chunk-AY4XMAS6.js";
import {
  script as script14
} from "./chunk-WHOSC5QW.js";
import {
  script as script11
} from "./chunk-ZWI3DSBC.js";
import {
  ConnectedOverlayScrollHandler,
  OverlayEventBus,
  _default,
  getVNodeProp
} from "./chunk-XLHYDHUG.js";
import {
  script as script10
} from "./chunk-NY32IK4E.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-TGYQW72D.js";
import {
  FocusTrap
} from "./chunk-NDPICYMH.js";
import {
  script as script6,
  script2 as script7
} from "./chunk-4QDSASFV.js";
import {
  script as script4,
  script2 as script5
} from "./chunk-FK7GVC74.js";
import {
  script as script3
} from "./chunk-FUEAV3FI.js";
import {
  Ripple
} from "./chunk-MN4Z5ZU3.js";
import {
  script as script2
} from "./chunk-SKWUFE3L.js";
import "./chunk-3LX3BLXE.js";
import {
  script as script8,
  script2 as script9
} from "./chunk-2KFQNAOH.js";
import {
  script
} from "./chunk-2M5HYWFB.js";
import {
  B,
  BaseStyle,
  C,
    ...
    onChange: function onChange4(event) {
      ...
      if (!this.disabled && !this.readonly) {
        ...
        if (this.binary) {
          ...
          else newModelValue = value ? [].concat(_toConsumableArray13(value), [this.value]) : [this.value];
        }
...
function _slicedToArray2(r, e) {
  return _arrayWithHoles2(r) || _iterableToArrayLimit2(r, e) || _unsupportedIterableToArray23(r, e) || _nonIterableRest2();
}
...
var script38 = {
  ...
  data: function data14() {
    return {
      ...
      d_multiSortMeta: this.multiSortMeta ? _toConsumableArray22(this.multiSortMeta) : [],
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data15 = _toConsumableArray22(value);
    ...
    sortMultiple: function sortMultiple(value) {
      ...
      if (this.groupRowsBy && (this.d_groupRowsSortMeta || this.d_multiSortMeta.length && this.groupRowsBy === this.d_multiSortMeta[0].field)) {
        ...
        if (firstSortMeta.field !== this.d_groupRowsSortMeta.field) {
          this.d_multiSortMeta = [this.d_groupRowsSortMeta].concat(_toConsumableArray22(this.d_multiSortMeta));
        }
      }
      var data15 = _toConsumableArray22(value);
      data15.sort(function(data1, data22) {
    ...
    addMultiSortField: function addMultiSortField(field2) {
      ...
      this.d_multiSortMeta = _toConsumableArray22(this.d_multiSortMeta);
    },
          ...
          if (metaSelection) {
            ...
            if (selected && metaKey) {
              ...
              if (this.isSingleSelectionMode()) {
                ...
                _selection2 = [].concat(_toConsumableArray22(_selection2), [rowData]);
            ...
            if (this.selectionMode === "single") {
              ...
              if (selected) {
                ...
                var _selection4 = this.selection ? [].concat(_toConsumableArray22(this.selection), [rowData]) : [rowData];
    ...
    toggleRowWithCheckbox: function toggleRowWithCheckbox2(event) {
      ...
      if (this.isSelected(rowData)) {
        ...
        var _selection5 = this.selection ? _toConsumableArray22(this.selection) : [];
        _selection5 = [].concat(_toConsumableArray22(_selection5), [rowData]);
    ...
    toggleRowsWithCheckbox: function toggleRowsWithCheckbox(event) {
      if (this.selectAll !== null) {
        ...
        var _selection = [];
        if (checked3) {
          _selection = this.frozenValue ? [].concat(_toConsumableArray22(this.frozenValue), _toConsumableArray22(this.processedData)) : this.processedData;
    ...
    generateCSV: function generateCSV(options, data15) {
      ...
      if (!data15) {
        ...
        else if (this.frozenValue) data15 = data15 ? [].concat(_toConsumableArray22(this.frozenValue), _toConsumableArray22(data15)) : this.frozenValue;
      }
    ...
    onColumnHeaderDrop: function onColumnHeaderDrop(e) {
      ...
      if (this.draggedColumnElement) {
        ...
        if (allowDrop) {
          ...
          var reorderedWidths = [].concat(_toConsumableArray22(remainingItems.slice(0, dropColIndex)), [movedItem], _toConsumableArray22(remainingItems.slice(dropColIndex)));
    ...
    onRowDrop: function onRowDrop2(event) {
      if (this.droppedRowIndex != null) {
        ...
        var processedData2 = _toConsumableArray22(this.processedData);
    ...
    toggleRow: function toggleRow2(event) {
      ...
      if (this.dataKey) {
        ...
        expandedRows = this.expandedRows ? _toConsumableArray22(this.expandedRows) : [];
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      ...
      var _expandedRowGroups = this.expandedRowGroups ? _toConsumableArray22(this.expandedRowGroups) : [];
    ...
    onRowEditInit: function onRowEditInit3(event) {
      var _editingRows = this.editingRows ? _toConsumableArray22(this.editingRows) : [];
      _editingRows.push(event.data);
      this.$emit("update:editingRows", _editingRows);
      this.$emit("row-edit-init", event);
    },
    onRowEditSave: function onRowEditSave3(event) {
      var _editingRows = _toConsumableArray22(this.editingRows);
  ...
  computed: {
    columns: function columns() {
      ...
      if (cols && this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray22(cols.filter(function(item) {
    ...
    allRowsSelected: function allRowsSelected() {
      ...
      if (this.selectAll !== null) {
        ...
        var val = this.frozenValue ? [].concat(_toConsumableArray22(this.frozenValue), _toConsumableArray22(this.processedData)) : this.processedData;
